...
export const resolveSharedBrowserExecutable = () => {
  ...
  const { destinationBinaryPath } = getVersionedInstallPaths({
    remotionVersion,
    platformTag,
  });
  return isExecutableFile(destinationBinaryPath) ? destinationBinaryPath : null;
};
